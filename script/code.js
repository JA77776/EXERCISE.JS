...
let paragraph = document.getElementsByClassName('paragraph')[0];
 paragraph.innerText ="This is a language I have mastered and I am proud of myself. I complished this because I believed in myself"
...
let question4 = document.getElementsByTagName("p")[1];
question4.innerText = "I have discovered that I can accomplish anything I put my mind to"
 ...
 let button = calculateButton.addEventListener('click', function() {
    let value1 = parseFloat(firstInput.value) || 0;
    let value2 = parseFloat(secondInput.value) || 0;
    resultSpan.textContent = value1 * value2;
 })
